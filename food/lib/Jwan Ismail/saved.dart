...
Lists(Title: 'Dubai', Subtitle: '1 property')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Container(margin: EdgeInsets.only(right:300),color: Colors.white,width: 400,height: 250,child: ListView.builder(itemCount: ListDetails.length,itemBuilder: (context, index) {
