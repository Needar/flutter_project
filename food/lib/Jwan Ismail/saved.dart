...
class _SavedScreenState extends State<SavedScreen> {
  ...
  hotels(Image: 'image/rixos1.jpg',Title: 'Rixos Hotel', Description: 'Duhok'),
  hotels(Image: 'image/erbil.jpg', Title: 'Divan Hotel', Description: 'Erbil'),
  hotels( Image:'image/sulimani.jpg',Title: 'Grand Millennium Hotel', Description: 'Sulaimani'),
  hotels(Image: 'image/istanbul.jpg', Title: 'Radisson Blu Hotel', Description: 'Istanbul'),
  hotels(Image: 'image/dubai.jpg', Title: 'Marco Polo Hotel', Description: 'Dubai')
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(   
      ...
      children:[Text('Recently saved',style:
      TextStyle(fontSize: 22,fontWeight: FontWeight.bold,letterSpacing: 1),
         
      ), 
      Text('More',style: TextStyle(color: Color.fromARGB(255, 69, 163, 240),
      ...
      Text(HotelsInfo[index].Description,style: TextStyle(color: Colors.grey[600],fontSize: 10),
      )
      ],
      ),
      ),
      Container(alignment: Alignment.topCenter,
      child: Stack(children: [Image(height: 70,width: 100,image: AssetImage(HotelsInfo[index].Image,),
      )
      ],
      ),
      ),
...
Lists(Title: 'Dubai', Subtitle: '1 property')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(child: Column(children: [SizedBox(height: 50,),
      Padding(padding: EdgeInsets.symmetric(vertical: 10),
      child: Row(children: [Text('Lists',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),
      )
      ],
      ),
      ),
      Container(margin: EdgeInsets.only(right:300),color: Colors.white,width: 700,height: 250,child: ListView.builder(itemCount: ListDetails.length,itemBuilder: (context, index) {
